...
def txtCvtCocoRotated(srcpath, destfile):
    img_folder = os.path.join(srcpath, 'trainval')
...
def main():
    srcpath = r'/mnt/lustre/yanhongchang/data/DOTA/rrpn15_512'
    destfile = r'/mnt/lustre/yanhongchang/data/DOTA/rrpn15_512/trainval2.json'
