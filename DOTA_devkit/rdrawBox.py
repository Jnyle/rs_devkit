...
def drawBoxsingle(imgpath, dstpath, nameboxdict, imgname):
    ...
    label = det[:, -1]
    image = draw_boxes_with_label_and_scores(outimg, bbox, confidence, label, 1)
...
if __name__ == '__main__':
    drwaBox(r'/mnt/lustre/yanhongchang/project/mmdetection/demo/work_dirs/out_img/faster_r50/tr_merge3/txt3',
                r'/mnt/lustre/yanhongchang/project/mmdetection/data/rrpn15_512/test',
                r'/mnt/lustre/yanhongchang/project/mmdetection/demo/work_dirs/out_img/faster_r50/tr_merge3/img3')
