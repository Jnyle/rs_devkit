...
def mergesingle(dstpath, nms, fullname):
    ...
    with open(fullname, 'r') as f_in:
        ...
        for splitline in splitlines:
            ...
            points = poly2origpoly(poly, x, y, rate)
...
if __name__ == '__main__':
    mergebypoly(r'/mnt/lustre/yanhongchang/project/mmdetection/demo/work_dirs/out_img/tr_faster_r50/crop1024/txt',
                r'/mnt/lustre/yanhongchang/project/mmdetection/demo/work_dirs/out_img/tr_faster_r50/crop1024/txt2')
    # mergebyrec()