# 注意headstr要根据实际情况修改folder,写成训练集或验证集所在文件夹名称
...
savepath = "/mfs/home/fangyong/data/guangdong/round1/VOC/train/"  # clw note: need modify 1
...
dataDir = '/mfs/home/fangyong/data/guangdong/round1/' # clw modify
...
for dataset in datasets_list:
    ...
    #classes_ids = classes_names    # 相当于一个索引的映射,如35类映射到21类,
